...
class OpenCasesFragment : Fragment(), OpenCasesAdapter.OpenCaseDelegate {
    ...
    override fun setOpenCaseToSolved(case: Case) {
        try {
            Toast.makeText(
                ...
                case.caseNumber.toString() + ": " + case.caseTitle,
                Toast.LENGTH_SHORT
            ).show()
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val list = mutableListOf(
            Case("The mystery of the missing shoe.", LatLng(-34.0, 151.0), true),
            Case("The hound of Baskerville", LatLng(-34.55, 151.0), true),
            Case("The missing charger.", LatLng(-34.4, 150.0), true),
            Case("Mystery at the headquarters", LatLng(33.9085, -84.4782), true)
        )
